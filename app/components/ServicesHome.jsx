...
const ServicesHome = () => {
  return (
    <>
      <div className="w-full mr-4 bg-white border border-gray-200 rounded-lg mt-5 shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <div id="fullWidthTabContent" className="border-t border-gray-200 dark:border-gray-600">
              <div className="p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="stats" role="tabpanel" aria-labelledby="stats-tab">
                  <div className="grid max-w-screen-xl grid-cols-2 gap-8 p-4 mx-auto text-gray-900 sm:grid-cols-3 xl:grid-cols-6 dark:text-white sm:p-8">
                      <div className="flex flex-col items-center justify-center">
                          <div className="mb-2 text-3xl font-extrabold"><AnimatedNumbers value={73} />M+</div>
                          <div className="text-gray-500 dark:text-gray-400">Developers</div>
                      </div>
                      <div className="flex flex-col items-center justify-center">
                          <div className="mb-2 text-3xl font-extrabold"><AnimatedNumbers value={100} />M+</div>
                          <div className="text-gray-500 dark:text-gray-400">Public repositories</div>
                      </div>
                      <div className="flex flex-col items-center justify-center">
                          <div className="mb-2 text-3xl font-extrabold"><AnimatedNumbers value={1000} />s</div>
                          <div className="text-gray-500 dark:text-gray-400">Open source projects</div>
                      </div>
                      <div className="flex flex-col items-center justify-center">
                          <div className="mb-2 text-3xl font-extrabold"><AnimatedNumbers value={100} />B+</div>
              ...
              <div className="hidden p-4 bg-white rounded-lg dark:bg-gray-800" id="faq" role="tabpanel" aria-labelledby="faq-tab">
                  <div id="accordion-flush" data-accordion="collapse" data-active-classes="bg-white dark:bg-gray-900 text-gray-900 dark:text-white" data-inactive-classNameNamees="text-gray-500 dark:text-gray-400">
